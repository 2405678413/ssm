...
<html>
	...
	<body>
		...
		<div class="head">
			<div class="wrapper clearfix">
				<div class="clearfix" id="top">
					<h1 class="fl"><a href="${pageContext.request.contextPath}/user/index"><img src="${pageContext.request.contextPath}/img/tea.png"/></a></h1>
					...
					<li>
						...
						<div class="sList2">
							<div class="clearfix">
								...
								<a href="${pageContext.request.contextPath}/user/bzproListg">抱枕靠垫</a>
							</div>
						</div>
					</li>
		...
		<!------------------------------banner------------------------------>
		<div class="banner">
			<a href="#"><img src="${pageContext.request.contextPath}/img/temp/banner1.jpg"/></a>
		</div>
		<!-----------------address------------------------------->
		<div class="address">
			<div class="wrapper clearfix">
				...
				<span>/</span>
				<a href="${pageContext.request.contextPath}/user/flowerDer" class="on">装饰摆件</a>
			</div>
		</div>
		<!-------------------current---------------------->
		<div class="current">
		...
		<ul class="proList wrapper clearfix">
			...
			<li>
				<a href="${pageContext.request.contextPath}/user/proDetail">
					<dl>
						<dt><img src="${pageContext.request.contextPath}/img/temp/vase01.jpg"></dt>
			...
			<li>
				<a href="${pageContext.request.contextPath}/user/proDetail">
					<dl>
						<dt><img src="${pageContext.request.contextPath}/img/temp/vase02.jpg"></dt>
			...
			<li>
				<a href="${pageContext.request.contextPath}/user/proDetail">
					<dl>
						<dt><img src="${pageContext.request.contextPath}/img/temp/vase03.jpg"></dt>
						<dd>【最家】北欧现代陶瓷花瓶摆件</dd>
						<dd>￥17.90</dd>
					</dl>
				</a>
			...
			<li>
				<a href="${pageContext.request.contextPath}/user/proDetail">
					<dl>
						<dt><img src="${pageContext.request.contextPath}/img/temp/vase04.jpg"></dt>
			...
			<li>
				<a href="${pageContext.request.contextPath}/user/proDetail">
					<dl>
						<dt><img src="${pageContext.request.contextPath}/img/temp/vase05.jpg"></dt>
			...
			<li>
				<a href="${pageContext.request.contextPath}/user/proDetail">
					<dl>
						<dt><img src="${pageContext.request.contextPath}/img/temp/vase06.jpg"></dt>
