	...
	<body>
		...
		<div class="detCon">
			<div class="proDet wrapper">
				<div class="proCon clearfix">
					<div class="proImg fl">
						<img class="det" src="${pageContext.request.contextPath}/img/temp/proDet.jpg" />
		...
		<div class="introMsg wrapper clearfix">
			<div class="msgL fl">
				...
				<div class="msgAll">
					<div class="msgImgs">
						<img src="${pageContext.request.contextPath}/img/temp/det01.jpg">
						<img src="${pageContext.request.contextPath}/img/temp/det02.jpg">
						<img src="${pageContext.request.contextPath}/img/temp/det03.jpg">
						<img src="${pageContext.request.contextPath}/img/temp/det04.jpg">
						<img src="${pageContext.request.contextPath}/img/temp/det05.jpg">
						<img src="${pageContext.request.contextPath}/img/temp/det06.jpg">
						<img src="${pageContext.request.contextPath}/img/temp/det07.jpg">
					</div>
					<div class="eva">
						<div class="per clearfix">
							<img class="fl" src="${pageContext.request.contextPath}/img/temp/per01.jpg">
							<div class="perR fl">
								<p>馨***呀</p>
								<p>不好意思评价晚了，产品很好，价格比玻璃品便宜，没有我担心的杂色，发货快，包装好，全5分</p>
								<div class="clearfix">
									<p><img src="${pageContext.request.contextPath}/img/temp/eva01.jpg"></p>
									<p><img src="${pageContext.request.contextPath}/img/temp/eva02.jpg"></p>
									<p><img src="${pageContext.request.contextPath}/img/temp/eva03.jpg"></p>
									<p><img src="${pageContext.request.contextPath}/img/temp/eva04.jpg"></p>
									<p><img src="${pageContext.request.contextPath}/img/temp/eva05.jpg"></p>
								</div>
								<p><span>2016年12月27日08:31</span><span>颜色分类：大中小三件套（不含花）</span></p>
							</div>
						</div>
						<div class="per clearfix">
							<img class="fl" src="${pageContext.request.contextPath}/img/temp/per02.jpg">
							<div class="perR fl">
								<p>么***周</p>
			...
			<div class="msgR fr">
				...
				<div class="seeList">
					<a href="#">
						<dl>
							<dt><img src="${pageContext.request.contextPath}/img/temp/see01.jpg"></dt>
							<dd>【最家】复古文艺风玻璃花瓶</dd>
							<dd>￥193.20</dd>
						</dl>
					</a>
					<a href="#">
						<dl>
							<dt><img src="${pageContext.request.contextPath}/img/temp/see02.jpg"></dt>
							<dd>【最家】复古文艺风玻璃花瓶</dd>
							<dd>￥193.20</dd>
						</dl>
					</a>
					<a href="#">
						<dl>
							<dt><img src="${pageContext.request.contextPath}/img/temp/see03.jpg"></dt>
							<dd>【最家】复古文艺风玻璃花瓶</dd>
							<dd>￥193.20</dd>
						</dl>
					</a>
					<a href="#">
						<dl>
							<dt><img src="${pageContext.request.contextPath}/img/temp/see04.jpg"></dt>
							<dd>【最家】复古文艺风玻璃花瓶</dd>
							<dd>￥193.20</dd>
						</dl>
					</a>
