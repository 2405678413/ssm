...
<div class="reg">
    <form action="#" method="post">
        ...
        <p>用户注册</p>
        <p><input type="text" name="name" value="" placeholder="请输入邮箱/电话号码"></p>
        <p><input type="password" name="pwd" value="" placeholder="请输入密码"></p>
        <p><input type="password" name="pwd" value="" placeholder="请确认密码"></p>
