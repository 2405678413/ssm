	...
	<body>
		...
		<div class="address">
			<div class="wrapper clearfix">
				...
				<a href="${pageContext.request.contextPath}/user/flowerDer">装饰摆件</a>
				<span>/</span>
				<a href="vase_${pageContext.request.contextPath}/user/proList" class="on">花瓶花器</a>
			</div>
		</div>
		<!-------------------current---------------------->
		<div class="current">
		...
		<ul class="proList wrapper clearfix">
			...
			<li>
				<a href="${pageContext.request.contextPath}/user/proDetail">
					<dl>
						<dt><img src="${pageContext.request.contextPath}/img/temp/vase07.jpg"></dt>
						<dd>【最家】地中海风情落地大花瓶</dd>
						<dd>￥17.90</dd>
					</dl>
				</a>
			...
			<li>
				<a href="${pageContext.request.contextPath}/user/proDetail">
					<dl>
						<dt><img src="${pageContext.request.contextPath}/img/temp/vase08.jpg"></dt>
						<dd>【最家】东南亚复古做旧大花瓶</dd>
						<dd>￥17.90</dd>
					</dl>
				</a>
