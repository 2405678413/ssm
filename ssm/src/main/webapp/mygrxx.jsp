		...
		<div class="Bott">
			<div class="wrapper clearfix">
				...
				<div class="you fl">
					<h2>个人信息</h2>
					<div class="gxin">
						<div class="tx"><a href="#"><img src="${pageContext.request.contextPath}/img/tx.png"/><p id="avatar">修改头像</p></a></div>
						<div class="xx">
							<h3 class="clearfix"><strong class="fl">基础资料</strong><a href="#" class="fr" id="edit1">编辑</a></h3>
							<div>姓名：<a>${user.user_realname}</a></div>
							<div>电话：<a>${user.user_tel}</a></div>
							<div>邮箱：<a>${user.user_email}</a></div>
							<div>状态：<a>${user.user_state}</a></div>
							<h3>高级设置</h3>
							<!--<div><span class="fl">银行卡</span><a href="#" class="fr">管理</a></div>-->
							<div><span class="fl">账号地区：<a>${user.user_address}</a></span><a href="#" class="fr" id="edit2">修改</a></div>
						</div>
					</div>			
				</div>
			</div>
