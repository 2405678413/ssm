        ...
        <form action="" name="ThisForm" method="post" >
            <table width="98%" align="center" border="0" cellspacing="0" cellpadding="0" style="margin-left:14px;margin-bottom:20px;">
                <tr>
                    ...
                    <td colspan="2"><input type="text" name="adminname" class="l-text1-input" /></td>
                </tr>
                <tr>
                    <td class="l-text1">密码：</td>
                    <td colspan="2"><input type="password" name="adminpwd" class="l-text1-input" /></td>
                </tr>
                <tr>
            ...
            <form action="${pageContext.request.contextPath}/admin/adminlogin" id="adminlogin" methods="post"> <input type="button" value="登录" /></form>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
