...
<html>
	...
	<body>
		...
		<div class="imgList1">
			<div class="wrapper">
				<div class="box1">
					<a href="proDetail.jsp" class="banner"><img src="${pageContext.request.contextPath}/img/idea1.jpg"/></a>
					<ul>
				...
				<div class="box2">
					<a href="proDetail.jsp" class="banner"><img src="${pageContext.request.contextPath}/img/idea22.jpg"/></a>
					<ul>
