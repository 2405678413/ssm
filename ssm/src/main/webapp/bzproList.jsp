...
<html>
	...
	<body>
		...
		<!------------------------------banner------------------------------>
		<div class="banner">
			<a href="#"><img src="${pageContext.request.contextPath}/img/temp/bzbig.jpg"/></a>
		</div>
		<!-----------------address------------------------------->
		<div class="address">
			<div class="wrapper clearfix">
				...
				<a href="${pageContext.request.contextPath}/user/decoration">布艺软饰</a>
				<span>/</span>
				<a href="${pageContext.request.contextPath}/user/bzproList" class="on">抱枕</a>
			</div>
		</div>
		<!-------------------current---------------------->
		<div class="current">
		...
		<ul class="proList wrapper clearfix">
			...
			<li>
				<dl>
					<dt><img src="${pageContext.request.contextPath}/img/temp/bz03.jpg"></dt>
					<dd>【最家】纯色棉麻抱枕</dd>
					<dd>￥47.90</dd>
				</dl>
			</li>
